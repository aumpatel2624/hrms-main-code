...
export const PaginationCardMinimal = ({
    ...
    className,
    onPageSizeChange,
    // ponytail: upstream hardcodes [10,25,50,100]; hoisted so callers can pass
    // their own (this app's tables use 50/100/200/300/all).
    pageSizeOptions = [10, 25, 50, 100],
}: PaginationCardMinimalProps & { pageSizeOptions?: number[] }) => {
    return (
            ...
            <nav aria-label="Pagination" className={cx("hidden items-center gap-3 md:flex", align === "center" && "justify-between")}>
                ...
                >
                    ...
                    <Select
                        ...
                        size="sm"
                        items={pageSizeOptions.map((n) => ({ label: `${n} per page`, id: n }))}
                    >
                        {(item) => (
