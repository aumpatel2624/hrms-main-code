...
A health insurance provider is a lookup list — Aetna, Cigna, and so on — an employee's insurance can be set against.

![Employee Health Insurances](../screenshots/employee-health-insurance-light.png "light")

![Employee Health Insurances](../screenshots/employee-health-insurance-dark.png "dark")

## When you would use this

Add a provider before assigning an employee's health insurance to it.
...
## Adding an Employee Health Insurance

Press **Add Employee Health Insurance** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create employee health insurance** at the bottom of the form.
...
![Adding an Employee Health Insurance](../screenshots/employee-health-insurance-add-light.png "light")

![Adding an Employee Health Insurance](../screenshots/employee-health-insurance-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing an Employee Health Insurance
...
![Viewing an Employee Health Insurance](../screenshots/employee-health-insurance-view-light.png "light")

![Viewing an Employee Health Insurance](../screenshots/employee-health-insurance-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing an Employee Health Insurance
...
![Editing an Employee Health Insurance](../screenshots/employee-health-insurance-edit-light.png "light")

![Editing an Employee Health Insurance](../screenshots/employee-health-insurance-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting an Employee Health Insurance

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this employee health insurance, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> You cannot delete a provider while records still reference it.
...
> HR Manager can add, edit and delete providers; HR User can view them but not change them.
