...
A reusable checklist of onboarding activities — laptop setup, ID card, orientation — for a role, department or grade.

![Onboarding Templates](../screenshots/employee-onboarding-template-light.png "light")

![Onboarding Templates](../screenshots/employee-onboarding-template-dark.png "dark")

## When you would use this

Build one before you have your first new hire in that role, then reuse it every time.
...
## Adding an Onboarding Template

Press **Add Onboarding Template** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create onboarding template** at the bottom of the form.
...
![Adding an Onboarding Template](../screenshots/employee-onboarding-template-add-light.png "light")

![Adding an Onboarding Template](../screenshots/employee-onboarding-template-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing an Onboarding Template
...
![Viewing an Onboarding Template](../screenshots/employee-onboarding-template-view-light.png "light")

![Viewing an Onboarding Template](../screenshots/employee-onboarding-template-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing an Onboarding Template
...
![Editing an Onboarding Template](../screenshots/employee-onboarding-template-edit-light.png "light")

![Editing an Onboarding Template](../screenshots/employee-onboarding-template-edit-dark.png "dark")
...
If something else in the system still refers to this onboarding template, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> Selecting a template on an Employee Onboarding copies its activities in at that moment — editing the template afterward does not change onboardings already created from it.
...
> HR User and HR Manager can add and edit templates; only HR Manager can delete one.
