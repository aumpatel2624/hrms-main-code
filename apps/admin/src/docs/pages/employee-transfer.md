...
Records a department, designation or branch change for an employee, and updates their record immediately.

![Employee Transfers](../screenshots/employee-transfer-light.png "light")

![Employee Transfers](../screenshots/employee-transfer-dark.png "dark")

## When you would use this

Create one when an employee moves department, designation or branch within the same company.

## What you fill in

- **Employee** *(required, chosen from a list)*
- **Transfer Date** *(required, a date)*
- **New Department** *(chosen from a list)*
- **New Designation** *(chosen from a list)*
- **New Branch** *(chosen from a list)*
...
## Adding an Employee Transfer

Press **Add Employee Transfer** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create employee transfer** at the bottom of the form.
...
![Adding an Employee Transfer](../screenshots/employee-transfer-add-light.png "light")

![Adding an Employee Transfer](../screenshots/employee-transfer-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing an Employee Transfer
...
![Viewing an Employee Transfer](../screenshots/employee-transfer-view-light.png "light")

![Viewing an Employee Transfer](../screenshots/employee-transfer-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing an Employee Transfer
...
![Editing an Employee Transfer](../screenshots/employee-transfer-edit-light.png "light")

![Editing an Employee Transfer](../screenshots/employee-transfer-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting an Employee Transfer

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this employee transfer, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> HR Manager can add and delete transfers; HR User can create and view but not edit or delete.
