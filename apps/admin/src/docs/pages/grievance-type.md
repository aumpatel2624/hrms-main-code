...
A classification master for employee grievances (e.g. Harassment, Workplace Safety).

![Grievance Types](../screenshots/grievance-type-light.png "light")

![Grievance Types](../screenshots/grievance-type-dark.png "dark")

## When you would use this

Set these up once, before staff start filing grievances, so every grievance can be categorized.
...
## Adding a Grievance Type

Press **Add Grievance Type** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create grievance type** at the bottom of the form.
...
![Adding a Grievance Type](../screenshots/grievance-type-add-light.png "light")

![Adding a Grievance Type](../screenshots/grievance-type-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Grievance Type
...
![Viewing a Grievance Type](../screenshots/grievance-type-view-light.png "light")

![Viewing a Grievance Type](../screenshots/grievance-type-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Grievance Type
...
![Editing a Grievance Type](../screenshots/grievance-type-edit-light.png "light")

![Editing a Grievance Type](../screenshots/grievance-type-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Grievance Type

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this grievance type, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> HR User and HR Manager can fully manage grievance types.
