...
Assigns a Holiday List to an Employee or a Company, from a given date onward.

![Holiday List Assignments](../screenshots/holiday-list-assignment-light.png "light")

![Holiday List Assignments](../screenshots/holiday-list-assignment-dark.png "dark")

## When you would use this

Use this to say which holiday calendar applies to whom.

## What you fill in

- **Holiday List** *(required, chosen from a list)*
- **Applicable For** *(required, chosen from a list)*
- **Employee** *(chosen from a list)*
- **Company** *(chosen from a list)*
- **Assignment Starts From** *(required, a date)*
...
## Adding a Holiday List Assignment

Press **Add Holiday List Assignment** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create holiday list assignment** at the bottom of the form.
...
![Adding a Holiday List Assignment](../screenshots/holiday-list-assignment-add-light.png "light")

![Adding a Holiday List Assignment](../screenshots/holiday-list-assignment-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Holiday List Assignment
...
![Viewing a Holiday List Assignment](../screenshots/holiday-list-assignment-view-light.png "light")

![Viewing a Holiday List Assignment](../screenshots/holiday-list-assignment-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Holiday List Assignment
...
![Editing a Holiday List Assignment](../screenshots/holiday-list-assignment-edit-light.png "light")

![Editing a Holiday List Assignment](../screenshots/holiday-list-assignment-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Holiday List Assignment

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this holiday list assignment, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
