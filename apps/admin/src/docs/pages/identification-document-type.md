...
A named type of personal ID (e.g. Passport, Aadhaar Card), used as a dropdown on Travel Request.

![Identification Document Types](../screenshots/identification-document-type-light.png "light")

![Identification Document Types](../screenshots/identification-document-type-dark.png "dark")

## When you would use this

Set these up once, before employees start submitting travel requests.

## What you fill in

- **Identification Document Type Name** *(required)*
...
## Adding an Identification Document Type

Press **Add Identification Document Type** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create identification document type** at the bottom of the form.
...
![Adding an Identification Document Type](../screenshots/identification-document-type-add-light.png "light")

![Adding an Identification Document Type](../screenshots/identification-document-type-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing an Identification Document Type
...
![Viewing an Identification Document Type](../screenshots/identification-document-type-view-light.png "light")

![Viewing an Identification Document Type](../screenshots/identification-document-type-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing an Identification Document Type
...
![Editing an Identification Document Type](../screenshots/identification-document-type-edit-light.png "light")

![Editing an Identification Document Type](../screenshots/identification-document-type-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting an Identification Document Type

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this identification document type, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> Admin only — no HR or Employee role has access to this screen.
