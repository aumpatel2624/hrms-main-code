...
A reusable interview round definition — technical round, HR round, and so on.

![Interview Types](../screenshots/interview-type-light.png "light")

![Interview Types](../screenshots/interview-type-dark.png "dark")

## When you would use this

Add one before scheduling an interview of that kind.

## What you fill in

### Details

- **Interview Type Name** *(required)*
- **Designation** *(chosen from a list)*
- **Expected Average Rating** *(a number)*
...
Press **Add Interview Type** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create interview type** at the bottom of the form.
...
![Adding an Interview Type](../screenshots/interview-type-add-light.png "light")

![Adding an Interview Type](../screenshots/interview-type-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing an Interview Type
...
![Viewing an Interview Type](../screenshots/interview-type-view-light.png "light")

![Viewing an Interview Type](../screenshots/interview-type-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing an Interview Type
...
![Editing an Interview Type](../screenshots/interview-type-edit-light.png "light")

![Editing an Interview Type](../screenshots/interview-type-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting an Interview Type

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this interview type, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> You cannot delete an interview type while records still reference it.
...
> Only HR User and HR Manager can add or edit interview types.
