...
A lookup list of where candidates come from — referral, job board, and so on.

![Job Applicant Sources](../screenshots/job-applicant-source-light.png "light")

![Job Applicant Sources](../screenshots/job-applicant-source-dark.png "dark")

## When you would use this

Add a source before assigning an applicant's source to it.
...
## Adding a Job Applicant Source

Press **Add Job Applicant Source** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create job applicant source** at the bottom of the form.
...
![Adding a Job Applicant Source](../screenshots/job-applicant-source-add-light.png "light")

![Adding a Job Applicant Source](../screenshots/job-applicant-source-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Job Applicant Source
...
![Viewing a Job Applicant Source](../screenshots/job-applicant-source-view-light.png "light")

![Viewing a Job Applicant Source](../screenshots/job-applicant-source-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Job Applicant Source
...
![Editing a Job Applicant Source](../screenshots/job-applicant-source-edit-light.png "light")

![Editing a Job Applicant Source](../screenshots/job-applicant-source-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Job Applicant Source

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this job applicant source, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> You cannot delete a source while records still reference it.
...
> Only HR User and HR Manager can add or edit sources.
