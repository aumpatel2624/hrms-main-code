...
![Job Applicants](../screenshots/job-applicant-light.png "light")

![Job Applicants](../screenshots/job-applicant-dark.png "dark")

## When you would use this

Add one when a candidate applies — by email, referral, or however they reached you.
...
- **Phone Number**
- **Job Opening** *(chosen from a list)*
- **Designation** *(chosen from a list)*
- **Source** *(chosen from a list)*
...
Press **Add Job Applicant** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create job applicant** at the bottom of the form.
...
![Adding a Job Applicant](../screenshots/job-applicant-add-light.png "light")

![Adding a Job Applicant](../screenshots/job-applicant-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Job Applicant
...
![Viewing a Job Applicant](../screenshots/job-applicant-view-light.png "light")

![Viewing a Job Applicant](../screenshots/job-applicant-view-dark.png "dark")
...
![Editing a Job Applicant](../screenshots/job-applicant-edit-light.png "light")

![Editing a Job Applicant](../screenshots/job-applicant-edit-dark.png "dark")
...
If something else in the system still refers to this job applicant, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> [!WARNING] Worth knowing
> If the opening has duplicate-application prevention on, the same email can't apply twice for it.
...
> Only HR User and HR Manager can add or edit job applicants.
