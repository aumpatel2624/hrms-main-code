...
A reusable set of terms an offer can copy from, instead of retyping them each time.

![Job Offer Term Templates](../screenshots/job-offer-term-template-light.png "light")

![Job Offer Term Templates](../screenshots/job-offer-term-template-dark.png "dark")

## When you would use this

Add one when you have a standard set of offer terms worth reusing.
...
## Adding a Job Offer Term Template

Press **Add Job Offer Term Template** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create job offer term template** at the bottom of the form.
...
![Adding a Job Offer Term Template](../screenshots/job-offer-term-template-add-light.png "light")

![Adding a Job Offer Term Template](../screenshots/job-offer-term-template-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Job Offer Term Template
...
![Viewing a Job Offer Term Template](../screenshots/job-offer-term-template-view-light.png "light")

![Viewing a Job Offer Term Template](../screenshots/job-offer-term-template-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Job Offer Term Template
...
![Editing a Job Offer Term Template](../screenshots/job-offer-term-template-edit-light.png "light")

![Editing a Job Offer Term Template](../screenshots/job-offer-term-template-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Job Offer Term Template

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this job offer term template, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> You cannot delete a template while records still reference it.
...
> Only HR User and HR Manager can add or edit templates.
