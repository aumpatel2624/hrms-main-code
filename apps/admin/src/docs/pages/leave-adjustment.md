...
A one-off manual correction to an employee's leave balance.

![Leave Adjustments](../screenshots/leave-adjustment-light.png "light")

![Leave Adjustments](../screenshots/leave-adjustment-dark.png "dark")

## When you would use this

Use this for a one-off correction the normal allocation/application flow doesn't cover — saving is the action, there is nothing to approve afterward.

## What you fill in

- **Employee** *(required, chosen from a list)*
- **Leave Type** *(required, chosen from a list)*
- **Allocation to Adjust (optional)** *(chosen from a list)*
- **Posting Date** *(a date)*
- **Leaves to Adjust** *(required, a number)*
- **Adjustment Type** *(required, chosen from a list)*
- **Reason for Adjustment** *(free text)*
...
## Adding a Leave Adjustment

Press **Add Leave Adjustment** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create leave adjustment** at the bottom of the form.
...
![Adding a Leave Adjustment](../screenshots/leave-adjustment-add-light.png "light")

![Adding a Leave Adjustment](../screenshots/leave-adjustment-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Leave Adjustment
...
![Viewing a Leave Adjustment](../screenshots/leave-adjustment-view-light.png "light")

![Viewing a Leave Adjustment](../screenshots/leave-adjustment-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Leave Adjustment
...
![Editing a Leave Adjustment](../screenshots/leave-adjustment-edit-light.png "light")

![Editing a Leave Adjustment](../screenshots/leave-adjustment-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Leave Adjustment

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this leave adjustment, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
