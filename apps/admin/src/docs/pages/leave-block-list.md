...
Dates on which Leave Applications are blocked, for a company and optionally one department and/or one Leave Type.

![Leave Block Lists](../screenshots/leave-block-list-light.png "light")

![Leave Block Lists](../screenshots/leave-block-list-dark.png "dark")

## When you would use this

Set one up before a blackout period (year-end close, a busy season) so leave can't be applied for on those dates.
...
- **Applies to All Departments** *(a yes/no tick box)*
- **Department** *(chosen from a list)*
- **Leave Type (blank = blocks every type)** *(chosen from a list)*
...
## Adding a Leave Block List

Press **Add Leave Block List** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create leave block list** at the bottom of the form.
...
![Adding a Leave Block List](../screenshots/leave-block-list-add-light.png "light")

![Adding a Leave Block List](../screenshots/leave-block-list-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Leave Block List
...
![Viewing a Leave Block List](../screenshots/leave-block-list-view-light.png "light")

![Viewing a Leave Block List](../screenshots/leave-block-list-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Leave Block List
...
![Editing a Leave Block List](../screenshots/leave-block-list-edit-light.png "light")

![Editing a Leave Block List](../screenshots/leave-block-list-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Leave Block List

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this leave block list, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
