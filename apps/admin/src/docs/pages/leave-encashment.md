...
Cashes out unused leave for a Leave Type that allows it.

![Leave Encashments](../screenshots/leave-encashment-light.png "light")

![Leave Encashments](../screenshots/leave-encashment-dark.png "dark")

## When you would use this

Use this to pay an employee for leave they won't use, instead of letting it expire or carry forward.
...
- **Leave Type (must Allow Encashment)** *(required, chosen from a list)*
- **Leave Allocation (optional — auto-resolved by date if blank)** *(chosen from a list)*
- **Encashment Date** *(a date)*
- **Encashment Days (blank = full eligible balance)** *(a number)*
- **Per Day Encashment Amount** *(required, a number)*

### Computed (read-only)

- **Leave Balance (at encashment time)** *(a number)*
- **Actual Encashable Days** *(a number)*
- **Encashment Amount** *(a number)*
...
## Adding a Leave Encashment

Press **Add Leave Encashment** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create leave encashment** at the bottom of the form.
...
![Adding a Leave Encashment](../screenshots/leave-encashment-add-light.png "light")

![Adding a Leave Encashment](../screenshots/leave-encashment-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Leave Encashment
...
![Viewing a Leave Encashment](../screenshots/leave-encashment-view-light.png "light")

![Viewing a Leave Encashment](../screenshots/leave-encashment-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Leave Encashment
...
![Editing a Leave Encashment](../screenshots/leave-encashment-edit-light.png "light")

![Editing a Leave Encashment](../screenshots/leave-encashment-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Leave Encashment

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this leave encashment, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> HR User and HR Manager only — no Employee access.
