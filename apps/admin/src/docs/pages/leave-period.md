...
A named date range (e.g. a fiscal year) that Leave Policy Assignments and Leave Allocations scope to.

![Leave Periods](../screenshots/leave-period-light.png "light")

![Leave Periods](../screenshots/leave-period-dark.png "dark")

## When you would use this

Create one per company per year before assigning leave policies for that year.
...
- **Holiday List for Optional Leave** *(chosen from a list)*
...
Press **Add Leave Period** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create leave period** at the bottom of the form.
...
![Adding a Leave Period](../screenshots/leave-period-add-light.png "light")

![Adding a Leave Period](../screenshots/leave-period-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Leave Period
...
![Viewing a Leave Period](../screenshots/leave-period-view-light.png "light")

![Viewing a Leave Period](../screenshots/leave-period-view-dark.png "dark")
...
![Editing a Leave Period](../screenshots/leave-period-edit-light.png "light")

![Editing a Leave Period](../screenshots/leave-period-edit-dark.png "dark")
...
If something else in the system still refers to this leave period, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> No two periods for the same company may overlap.
...
> HR User and HR Manager can fully manage leave periods; Employees can only view them.
