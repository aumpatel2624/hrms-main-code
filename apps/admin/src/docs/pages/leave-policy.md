...
A named bundle of (Leave Type, annual allocation) pairs.

![Leave Policies](../screenshots/leave-policy-light.png "light")

![Leave Policies](../screenshots/leave-policy-dark.png "dark")

## When you would use this

Build one per employee group/grade, then assign it via Leave Policy Assignment.
...
Press **Add Leave Policy** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create leave policy** at the bottom of the form.
...
![Adding a Leave Policy](../screenshots/leave-policy-add-light.png "light")

![Adding a Leave Policy](../screenshots/leave-policy-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Leave Policy
...
![Viewing a Leave Policy](../screenshots/leave-policy-view-light.png "light")

![Viewing a Leave Policy](../screenshots/leave-policy-view-dark.png "dark")
...
![Editing a Leave Policy](../screenshots/leave-policy-edit-light.png "light")

![Editing a Leave Policy](../screenshots/leave-policy-edit-dark.png "dark")
...
If something else in the system still refers to this leave policy, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
