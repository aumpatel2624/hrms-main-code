...
A named reason for travel (e.g. Client Meeting, Conference), used as a dropdown on Travel Request.

![Purposes of Travel](../screenshots/purpose-of-travel-light.png "light")

![Purposes of Travel](../screenshots/purpose-of-travel-dark.png "dark")
...
- **Purpose of Travel Name** *(required)*
...
## Adding a Purpose of Travel

Press **Add Purpose of Travel** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create purpose of travel** at the bottom of the form.
...
![Adding a Purpose of Travel](../screenshots/purpose-of-travel-add-light.png "light")

![Adding a Purpose of Travel](../screenshots/purpose-of-travel-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Purpose of Travel
...
![Viewing a Purpose of Travel](../screenshots/purpose-of-travel-view-light.png "light")

![Viewing a Purpose of Travel](../screenshots/purpose-of-travel-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Purpose of Travel
...
![Editing a Purpose of Travel](../screenshots/purpose-of-travel-edit-light.png "light")

![Editing a Purpose of Travel](../screenshots/purpose-of-travel-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Purpose of Travel

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this purpose of travel, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
