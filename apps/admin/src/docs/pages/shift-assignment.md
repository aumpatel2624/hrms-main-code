...
Give an employee one shift for a date range.

![Shift Assignments](../screenshots/shift-assignment-light.png "light")

![Shift Assignments](../screenshots/shift-assignment-dark.png "dark")
...
## Adding a Shift Assignment

Press **Add Shift Assignment** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create shift assignment** at the bottom of the form.
...
![Adding a Shift Assignment](../screenshots/shift-assignment-add-light.png "light")

![Adding a Shift Assignment](../screenshots/shift-assignment-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Shift Assignment
...
![Viewing a Shift Assignment](../screenshots/shift-assignment-view-light.png "light")

![Viewing a Shift Assignment](../screenshots/shift-assignment-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Shift Assignment
...
![Editing a Shift Assignment](../screenshots/shift-assignment-edit-light.png "light")

![Editing a Shift Assignment](../screenshots/shift-assignment-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Shift Assignment

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this shift assignment, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
