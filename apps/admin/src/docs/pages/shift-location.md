...
Set where employees may check in when they supply their location.

![Shift Locations](../screenshots/shift-location-light.png "light")

![Shift Locations](../screenshots/shift-location-dark.png "dark")
...
## Adding a Shift Location

Press **Add Shift Location** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create shift location** at the bottom of the form.
...
![Adding a Shift Location](../screenshots/shift-location-add-light.png "light")

![Adding a Shift Location](../screenshots/shift-location-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Shift Location
...
![Viewing a Shift Location](../screenshots/shift-location-view-light.png "light")

![Viewing a Shift Location](../screenshots/shift-location-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Shift Location
...
![Editing a Shift Location](../screenshots/shift-location-edit-light.png "light")

![Editing a Shift Location](../screenshots/shift-location-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Shift Location

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this shift location, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
