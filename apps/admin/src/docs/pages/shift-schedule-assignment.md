...
Generate dated assignments from a repeating schedule.

![Shift Schedule Assignments](../screenshots/shift-schedule-assignment-light.png "light")

![Shift Schedule Assignments](../screenshots/shift-schedule-assignment-dark.png "dark")
...
- **Shift schedule** *(required, chosen from a list)*
- **Shift location** *(chosen from a list)*
- **Enabled** *(a yes/no tick box)*
- **Create shifts after** *(a date)*
...
## Adding a Shift Schedule Assignment

Press **Add Shift Schedule Assignment** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create shift schedule assignment** at the bottom of the form.
...
![Adding a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-add-light.png "light")

![Adding a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Shift Schedule Assignment
...
![Viewing a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-view-light.png "light")

![Viewing a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Shift Schedule Assignment
...
![Editing a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-edit-light.png "light")

![Editing a Shift Schedule Assignment](../screenshots/shift-schedule-assignment-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Shift Schedule Assignment

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this shift schedule assignment, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
