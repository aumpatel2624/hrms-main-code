...
An employee's feedback on a training session they attended.

![Training Feedback](../screenshots/training-feedback-light.png "light")

![Training Feedback](../screenshots/training-feedback-dark.png "dark")

## When you would use this

Collect this after a Training Event is marked Completed.

## What you fill in

- **Employee** *(required, chosen from a list)*
- **Training Event** *(required, chosen from a list)*
...
## Adding a Training Feedback

Press **Add Training Feedback** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create training feedback** at the bottom of the form.
...
![Adding a Training Feedback](../screenshots/training-feedback-add-light.png "light")

![Adding a Training Feedback](../screenshots/training-feedback-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Training Feedback
...
![Viewing a Training Feedback](../screenshots/training-feedback-view-light.png "light")

![Viewing a Training Feedback](../screenshots/training-feedback-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Training Feedback
...
![Editing a Training Feedback](../screenshots/training-feedback-edit-light.png "light")

![Editing a Training Feedback](../screenshots/training-feedback-edit-dark.png "dark")

*Needs the **edit** permission — without it the button is not shown.*

## Deleting a Training Feedback

Press the delete icon on a row. You are asked to confirm first, and nothing is removed until you do.

If something else in the system still refers to this training feedback, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> HR Manager can fully manage training feedback; HR User can edit existing entries but not create or delete; Employees can create, read and edit (not delete) their own.
