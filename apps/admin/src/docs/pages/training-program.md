...
A training curriculum, e.g. a recurring course or workshop series.

![Training Programs](../screenshots/training-program-light.png "light")

![Training Programs](../screenshots/training-program-dark.png "dark")

## When you would use this

Set one up before scheduling individual Training Events under it.
...
Press **Add Training Program** at the top right of the list. That opens a blank form.

1. Fill in the fields described above. Required ones are marked with an asterisk.
2. Press **Create training program** at the bottom of the form.
...
![Adding a Training Program](../screenshots/training-program-add-light.png "light")

![Adding a Training Program](../screenshots/training-program-add-dark.png "dark")

*Needs the **write** permission — without it the button is not shown.*

## Viewing a Training Program
...
![Viewing a Training Program](../screenshots/training-program-view-light.png "light")

![Viewing a Training Program](../screenshots/training-program-view-dark.png "dark")

*Needs the **read** permission — without it the button is not shown.*

## Editing a Training Program
...
![Editing a Training Program](../screenshots/training-program-edit-light.png "light")

![Editing a Training Program](../screenshots/training-program-edit-dark.png "dark")
...
If something else in the system still refers to this training program, the deletion is refused and you are told what is using it. Clear or reassign those first, then try again.
...
> HR Manager can fully manage training programs; HR User can edit existing ones but not create or delete.
