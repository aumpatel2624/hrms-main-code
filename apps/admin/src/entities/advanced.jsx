...
export const employeeConfig = {
    ...
    fields: [
        ...
        { name: "ifscCode", label: "IFSC Code", section: "regional" },
        { name: "panNumber", label: "PAN Number", section: "regional" },
        { name: "micrCode", label: "MICR Code", section: "regional" },
        { name: "providentFundAccount", label: "Provident Fund Account", section: "regional" },
...
export const salaryComponentConfig = {
    ...
    fields: [
        ...
        { name: "companyId", label: "Company", section: "details", type: "select", optionsFrom: "companyId", required: true, error: "Company is required" },
        { name: "componentType", label: "Regional Component Type", section: "details", type: "select", options: ["", "Provident Fund", "Additional Provident Fund", "Provident Fund Loan", "Professional Tax"] },
...
export const incomeTaxSlabConfig = {
    ...
    fields: [
        ...
        { name: "marginalReliefLimit", label: "Marginal Relief Limit", section: "details", type: "number", hint: "Optional — caps tax in the income range immediately above Tax Relief Limit." },
...
export const employeeTaxExemptionDeclarationConfig = {
    ...
    fields: [
        ...
        { name: "payrollPeriodId", label: "Payroll Period", section: "details", type: "select", optionsFrom: "payrollPeriodId", required: true, error: "Payroll Period is required" },
        { name: "currency", label: "Currency", section: "details", type: "text" },
        { name: "monthlyHouseRent", label: "Monthly House Rent", section: "details", type: "number" },
        { name: "rentedInMetroCity", label: "Rented in Metro City", section: "details", type: "checkbox" },
        { name: "annualHraExemption", label: "Annual HRA Exemption", section: "details", type: "number", disabled: () => true },
        { name: "monthlyHraExemption", label: "Monthly HRA Exemption", section: "details", type: "number", disabled: () => true },
        { name: "hraAmount", label: "Annual HRA Amount", section: "details", type: "number", disabled: () => true },
...
export const employeeTaxExemptionProofSubmissionConfig = {
    ...
    fields: [
        ...
        { name: "currency", label: "Currency", section: "details", type: "text" },
        { name: "houseRentPaymentAmount", label: "House Rent Payment Amount", section: "details", type: "number" },
        { name: "rentedFrom", label: "Rented From", section: "details", type: "date" },
        { name: "rentedTo", label: "Rented To", section: "details", type: "date" },
        { name: "rentedInMetroCity", label: "Rented in Metro City", section: "details", type: "checkbox" },
        { name: "monthlyHouseRent", label: "Monthly House Rent", section: "details", type: "number", disabled: () => true },
        { name: "totalEligibleHraExemption", label: "Eligible HRA Exemption", section: "details", type: "number", disabled: () => true },
        { name: "hraAmount", label: "Annual HRA Amount", section: "details", type: "number", disabled: () => true },
