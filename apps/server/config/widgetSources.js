...
export const WIDGET_SOURCES = Object.freeze({
  ...
  "gratuity-rules": {
    label: "Gratuity Rule",
    model: "GratuityRule",
    menuUrl: "/gratuity-rule",
    aggregatable: { totalWorkingDaysPerYear: "Total working days per year", minimumYearForGratuity: "Minimum year for gratuity" },
    groupable: {
      disable: { label: "Disabled" },
      calculateGratuityAmountBasedOn: { label: "Calculate based on" },
      workExperienceCalculationFunction: { label: "Work experience method" },
    },
    dateFields: { createdAt: "Created" },
    filterable: {
      name: "string",
  ...
  "gratuities": {
    ...
    model: "Gratuity",
    menuUrl: "/gratuity",
    aggregatable: { amount: "Amount", currentWorkExperience: "Current work experience" },
    groupable: {
      status: { label: "Status" },
      companyId: { label: "Company", lookup: { from: "companies", labelField: "companyName" } },
      employeeId: { label: "Employee", lookup: { from: "employees", labelField: "employeeName" } },
      gratuityRuleId: { label: "Gratuity Rule", lookup: { from: "gratuityrules", labelField: "name" } },
    },
    dateFields: { postingDate: "Posting date", payrollDate: "Payroll date", createdAt: "Created" },
    filterable: {
      employeeId: "objectId",
      companyId: "objectId",
  ...
  "employee-feedback-criteria": {
    ...
    model: "EmployeeFeedbackCriteria",
    menuUrl: "/employee-feedback-criteria",
    aggregatable: {},
    groupable: {},
    dateFields: { createdAt: "Created" },
  ...
  "appraisal-cycles": {
    ...
    menuUrl: "/appraisal-cycle",
    aggregatable: {},
    groupable: {
      status: { label: "Status" },
      kraEvaluationMethod: { label: "KRA Evaluation Method" },
      companyId: { label: "Company", lookup: { from: "companies", labelField: "companyName" } },
    },
    dateFields: { startDate: "Start date", endDate: "End date", createdAt: "Created" },
    filterable: {
  ...
  "appraisals": {
    ...
    aggregatable: {
      ...
      avgFeedbackScore: "Average feedback score",
    ...
    groupable: {
      ...
      employeeId: { label: "Employee", lookup: { from: "employees", labelField: "employeeName" } },
      companyId: { label: "Company", lookup: { from: "companies", labelField: "companyName" } },
      appraisalCycleId: { label: "Appraisal Cycle", lookup: { from: "appraisalcycles", labelField: "cycleName" } },
      appraisalTemplateId: { label: "Appraisal Template", lookup: { from: "appraisaltemplates", labelField: "templateTitle" } },
    },
    dateFields: { startDate: "Start date", endDate: "End date", createdAt: "Created" },
    filterable: {
      employeeId: "objectId",
  ...
  "goals": {
    ...
    model: "Goal",
    menuUrl: "/goal",
    aggregatable: { progress: "Progress" },
    groupable: {
      status: { label: "Status" },
      isGroup: { label: "Is Group" },
      employeeId: { label: "Employee", lookup: { from: "employees", labelField: "employeeName" } },
      companyId: { label: "Company", lookup: { from: "companies", labelField: "companyName" } },
      appraisalCycleId: { label: "Appraisal Cycle", lookup: { from: "appraisalcycles", labelField: "cycleName" } },
      kraId: { label: "KRA", lookup: { from: "kras", labelField: "name" } },
    },
    dateFields: { startDate: "Start date", endDate: "End date", createdAt: "Created" },
    filterable: {
      goalName: "string",
  ...
  "employee-performance-feedbacks": {
    ...
    model: "EmployeePerformanceFeedback",
    menuUrl: "/employee-performance-feedback",
    aggregatable: { totalScore: "Total score" },
    groupable: {
      status: { label: "Status" },
      employeeId: { label: "Employee", lookup: { from: "employees", labelField: "employeeName" } },
      reviewerId: { label: "Reviewer", lookup: { from: "employees", labelField: "employeeName" } },
      companyId: { label: "Company", lookup: { from: "companies", labelField: "companyName" } },
      appraisalCycleId: { label: "Appraisal Cycle", lookup: { from: "appraisalcycles", labelField: "cycleName" } },
    },
    dateFields: { createdAt: "Created" },
