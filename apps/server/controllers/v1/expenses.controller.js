...
export const createExpenseClaim = async (req, res) => { try {
  ...
  if (expenses.length === 0) throwError(400, "An Expense Claim must have at least one expense row");
