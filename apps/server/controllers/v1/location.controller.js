...
export const deleteCountry = async (req, res) => {
  try {
    ...
    await CountryModels.findByIdAndUpdate(countryId, { isDeleted: true });
...
export const listCountryByParams = async (req, res) => {
  try {
    const list = await runListQuery(CountryModels, req.body, {
...
export const deleteState = async (req, res) => {
  try {
    ...
    await StateModels.findByIdAndUpdate(stateId, { isDeleted: true });
...
export const listStateByParams = async (req, res) => {
  try {
    const list = await runListQuery(StateModels, req.body, {
      searchFields: ["stateName", "stateCode", "countryName"],
      filterable: {
        stateName: "string",
        stateCode: "string",
        countryName: "string",
        ...
        { $addFields: { countryName: { $ifNull: ["$country.countryName", ""] } } },
            ],
    });
...
export const deleteCity = async (req, res) => {
  try {
    ...
    await CityModels.findByIdAndUpdate(cityId, { isDeleted: true });
...
export const listCityByParams = async (req, res) => {
  try {
    const list = await runListQuery(CityModels, req.body, {
      searchFields: ["cityName", "cityCode", "stateName", "countryName"],
      filterable: {
        cityName: "string",
        cityCode: "string",
        stateName: "string",
        ...
        { $addFields: { stateName: { $ifNull: ["$state.stateName", ""] } } },
            ],
    });
