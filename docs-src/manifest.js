...
export const CONFIG_SCREENS = [
    ...
    },
    {
        ...
        config: "employeeBenefitApplicationConfig",
        source: "apps/admin/src/entities/advanced.jsx",
        intro: "Annual or periodic flexible benefit election allocating employee allowance across eligible components.",
        when: "Employees submit benefit elections during an enrollment window, or HR sets up benefit packages.",
        gotchas: [
            "Total benefit amount cannot exceed the employee's max benefits ceiling on their assignment.",
            "Components with payout method 'Accrue and payout at end of payroll period' cannot be chosen in an election.",
        ],
        roles: "Employees can create and view their own draft elections; HR User and HR Manager have full access across their company.",
    },
    {
        key: "employee-benefit-claim",
        config: "employeeBenefitClaimConfig",
        source: "apps/admin/src/entities/advanced.jsx",
        intro: "Disbursement claims submitted by employees against their flexible benefit balance.",
        when: "Employees claim reimbursement for medical, telephone, leave travel, or other flexible allowances.",
        gotchas: [
            "Claimed amount cannot exceed the eligible accrued amount or remaining annual allocation.",
            "Submitting creates an active Additional Salary row for payroll payout; cancelling cascades to cancel that Additional Salary.",
        ],
        roles: "Employees can submit claims for themselves; HR User and HR Manager review and approve claims across their company.",
    },
    {
        key: "employee-benefit-ledger",
        config: "employeeBenefitLedgerConfig",
        source: "apps/admin/src/entities/advanced.jsx",
        intro: "Append-only operational running balance of flexible benefit accruals and payouts per employee and component.",
        when: "Auditing benefit balances, reviewing payout history, or checking employee benefit utilization.",
        gotchas: [
            "Read-only domain ledger: records are generated by Salary Slip lifecycle, Claims, and Corrections, never directly edited.",
        ],
        roles: "Employees can view their own ledger history; HR User and HR Manager can view all ledger records in their company.",
    },
    {
        key: "payroll-correction",
        config: "payrollCorrectionConfig",
        source: "apps/admin/src/entities/advanced.jsx",
        intro: "Reverses mistaken LWP days on submitted Salary Slips, generating earning/deduction arrears and benefit accrual top-ups.",
        when: "Attendance regularisation or approved late leave applications convert unpaid absence back into paid days.",
        gotchas: [
            "Days to reverse cannot exceed the available LWP days remaining on the target Salary Slip.",
            "Submitting creates Additional Salary adjustment rows and Benefit Ledger accrual rows; cancelling reverses both.",
        ],
        roles: "HR User and HR Manager manage records within their company.",
    },
];
